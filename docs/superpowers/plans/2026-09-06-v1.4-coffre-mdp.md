...
Expected: FAIL sur les 4 nouveaux tests (`test_classe_en_coffre_deverrouillee_sans_ressaisie`, `test_refus_utiliser_coffre_saisie_manuelle_pour_toutes`, `test_trois_echecs_mdp_maitre_replie_en_manuel`, `test_mdp_argument_ignore_le_coffre`) — la boucle ne consulte pas encore le coffre.
